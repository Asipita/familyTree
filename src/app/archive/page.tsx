    ...
    <main className="archive-page archive-tree-page">
      <aside className="archive-sidebar">
        ...
        <nav className="archive-nav" aria-label="Archive navigation">
          ...
          <a className="archive-nav-item" href="#tree"><UsersRound size={17} /> People <span className="archive-nav-count">{memberCount}</span></a>
        </nav>
        ...
        <div className="archive-sidebar-bottom">
          <div className="archive-sidebar-summary">
            ...
            <div className="archive-summary-stats"><span><strong>12</strong><small>stories</small></span><span><strong>{memberCount}</strong><small>people</small></span><span><strong>3</strong><small>generations</small></span></div>
      ...
      <section className="archive-main archive-tree-main" id="tree">
        <FamilyTreeCanvas onMemberCountChange={setMemberCount} />
        <div className="archive-tree-overlay archive-tree-overlay-title">
          ...
          <small>Explore the people who made you possible</small>
        </div>
      </section>
    </main>
  );
